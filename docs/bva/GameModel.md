...
- **TC1: GameModel constructs without error** ( :x: )
...
- **TC2: Creates exactly 6 continents** ( :x: )
...
- **TC3: Creates exactly 42 territories across all continents** ( :x: )
