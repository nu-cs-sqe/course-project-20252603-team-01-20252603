...
- **TC105: Rejects attacker rolling zero dice** ( :x: )
...
- **TC107: Rejects attacker rolling more dice than armies minus one allows** ( :x: )
...
- **TC108: Rejects defender rolling zero dice** ( :x: )
...
- **TC109: Rejects defender rolling more than two dice** ( :x: )
...
- **TC110: Rejects defender rolling more dice than defending territory armies allow** ( :x: )
