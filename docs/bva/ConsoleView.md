...
- **TC46: Returns below-minimum attacker dice count for controller and model validation** ( :x: )
...
- **TC47: Returns above-maximum attacker dice count for controller and model validation** ( :x: )
