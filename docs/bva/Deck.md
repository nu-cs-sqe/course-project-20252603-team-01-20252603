...
- **TC8: Returns false on fresh deck** ( :x: )
    - **State of the system**: Freshly constructed `Deck`
...
- **TC9: Deck still contains 44 cards after shuffle** ( :x: )
...
- **TC10: Deck order changes after shuffle** ( :x: )
